          ...
          {[
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-xs font-semibold cursor-pointer transition-all ${isActive
          ...
          {[
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 py-1.5 px-3 rounded-lg text-[11px] font-bold whitespace-nowrap cursor-pointer transition-all ${isActive
                                  ...
                                  {lesionScans.map((scan, sIdx) => {
                                    ...
                                    return (
                                      <div key={scan.id} className="relative group">
                                        {/* Timeline Dot */}
                                        <div className={`absolute -left-[26px] top-1 h-3.5 w-3.5 rounded-full border-2 bg-white flex items-center justify-center transition-all ${isLatest ? "border-teal-500 scale-110 shadow-sm" : "border-slate-300"
                                          }`}>
                                        ...
                                        <div className="flex justify-between items-start gap-4">
                                          ...
                                          <div className="flex items-center gap-2">
                                            <span className={`text-[8px] font-bold px-1.5 py-0.2 rounded uppercase ${scan.status === "reviewed"
                        ...
                        <div className="lg:col-span-5 space-y-3 max-h-72 overflow-y-auto pr-1">
                          ...
                          {relatedScans.slice().reverse().map((scan) => {
                            ...
                            return (
                              <div
                                key={scan.id}
                                className={`p-3 rounded-xl border flex items-center justify-between gap-3 text-xs transition-all ${isCurrent
                              ...
                              >
                                ...
                                <div className="text-right">
                                  <span className={`text-[9px] font-bold px-2 py-0.5 rounded border block mb-1 ${scan.riskLevel === "High"
                  ...
                  <div className="h-44 flex items-end gap-3 pt-6 pb-2 px-4 border-b border-l border-slate-100 max-w-xl">
                    {scans.slice().reverse().map((s, idx) => (
                      <div key={s.id} className="flex-1 flex flex-col items-center gap-2">
                        ...
                        <div
                          className={`w-full rounded-t-md transition-all duration-300 ${s.riskLevel === "High" ? "bg-rose-400" : s.riskLevel === "Medium" ? "bg-amber-400" : "bg-emerald-400"
                            }`}
                    ...
                    {consultations.map((consult) => (
                      <div key={consult.id} className="p-5 space-y-3">
                        <div className="flex justify-between items-start gap-4">
                          ...
                          <span className={`text-[10px] font-bold px-2.5 py-0.5 rounded-full border ${consult.status === "completed"
                    ...
                    {referrals.map((ref) => (
                      <div key={ref.id} className="p-5 space-y-3 hover:bg-slate-50/40 transition-colors">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                          ...
                          <span className={`text-[10px] font-bold px-2.5 py-0.5 rounded-full border ${ref.status === "discharged" || ref.status === "completed"
                              ? "bg-emerald-50 border-emerald-100 text-emerald-800"
                              : "bg-amber-50 border-amber-100 text-amber-800"
                            }`}>
